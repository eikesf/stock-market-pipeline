...
for d in [
    LANDING_PRICES_DIR, LANDING_METADATA_DIR,
    ARCHIVE_PRICES_DIR, ARCHIVE_METADATA_DIR,
    BRONZE_PRICES_DIR, BRONZE_METADATA_DIR,
    SILVER_PRICES_DIR, SILVER_METADATA_DIR
]:
