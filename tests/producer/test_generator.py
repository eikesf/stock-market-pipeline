...
class TestPriceGenerator:
    ...
    def test_run_generator_success_multi_index(self, mock_to_parquet, mock_download, mock_get_all_tickers):
        ...
        columns = pd.MultiIndex.from_tuples([
            ("Open", "AAPL"), ("Open", "PETR4.SA"),
            ("Close", "AAPL"), ("Close", "PETR4.SA"),
            ("High", "AAPL"), ("High", "PETR4.SA"),
            ("Low", "AAPL"), ("Low", "PETR4.SA"),
            ("Adj Close", "AAPL"), ("Adj Close", "PETR4.SA"),
            ("Volume", "AAPL"), ("Volume", "PETR4.SA"),
            ("Dividends", "AAPL"), ("Dividends", "PETR4.SA"),
            ("Stock Splits", "AAPL"), ("Stock Splits", "PETR4.SA")
        ])
    ...
    def test_run_generator_latest_date_filtering(self, mock_to_parquet, mock_download, mock_get_all_tickers):
        ...
        columns = pd.MultiIndex.from_tuples([
            ("Open", "AAPL"), ("Open", "NVDA"),
            ("Close", "AAPL"), ("Close", "NVDA"),
            ("High", "AAPL"), ("High", "NVDA"),
            ("Low", "AAPL"), ("Low", "NVDA"),
            ("Adj Close", "AAPL"), ("Adj Close", "NVDA"),
            ("Volume", "AAPL"), ("Volume", "NVDA")
        ])
